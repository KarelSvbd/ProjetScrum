...
<html>
    ...
    <body>
        ...
        <div id="baliseImgArticle"><img src="/Site_DropShipping/Ressources/Banane.jpg" width="70%"></div>
        ...
        <button id="btnCommander" onclick="commandeBanane()">Commander - 14,99 CHF</button>
